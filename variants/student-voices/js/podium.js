...
var thisApp = {
	data: [],
	voiceBox: '<div class="rt-voice" voice=""><div><img src=""><h2></h2><h4></h4><h4></h4></div><div><p></p></div></div>',
	...
	populateBoxes: function(total){
		...
		for (var i = 1 ; i < total ; i++){
			...
			jQuery('#rt-main .rt-voice:eq('+ii+') h2').text(thisApp.data[i][4]);
			jQuery('#rt-main .rt-voice:eq('+ii+') h4:eq(0)').add('#rt-segs .rt-voice:eq('+ii+') h2').text(thisApp.data[i][0]);
			jQuery('#rt-main .rt-voice:eq('+ii+') h4:eq(1)').add('#rt-nav .rt-voice:eq('+ii+') h4').add('#rt-segs .rt-voice:eq('+ii+') h4').text(thisApp.data[i][1]);
